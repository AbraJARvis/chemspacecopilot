...
QSAR_TRAINING_INSTRUCTIONS = [
    ...
    "  - For curated QSAR datasets, pass `smiles` to `prepare_training_dataset`, `smiles_to_morgan_fingerprints`, and `smiles_to_rdkit_descriptors` unless the tool result explicitly says another curated SMILES column was produced.",
