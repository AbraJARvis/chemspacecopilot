...
QSAR_REPORT_INSTRUCTIONS = [
    ...
    "  - Report the neighborhood policy explicitly when present: fingerprint, radius, bit count, similarity metric, similarity threshold, top-k neighbors, flag threshold, and normalization.",
    "  - If no loops were requested, state explicitly that no compounds were removed.",
    "  - If loops were requested, include a compact variants table with variant_id, removed_tiers, removed_count, remaining_rows, and comparable holdout metrics when present.",
