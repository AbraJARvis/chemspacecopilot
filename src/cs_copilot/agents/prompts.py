...
QSAR_REPORT_INSTRUCTIONS = [
    ...
    "  - The first three blocks must follow a standardized pattern whenever information is available:",
    "    1. Title",
    "    2. A very short introduction paragraph beginning with 'Voici les resultats...' or equivalent",
    "    3. `Partie 1 : Curation` with only the essential curation facts",
    ...
    "  - After that, continue with the rest of the workflow sections as needed: training, metrics, predictions, caveats, generated files.",
