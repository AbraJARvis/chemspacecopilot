...
DATASET_CURATION_INSTRUCTIONS = [
    ...
    "  - Treat ChEMBL standardization as a real chemistry step: checker diagnostics, standardize_mol, get_parent_mol, salt/solvent stripping, and QSAR identity generation.",
