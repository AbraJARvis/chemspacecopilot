...
QSAR_TRAINING_INSTRUCTIONS = [
    ...
    "  - If the user asks for one LightGBM/Chemprop/TabICL model, or for Activity-Cliff feedback loops on one model, complete that single training workflow with the corresponding QSAR training facade tool only. Do not start a benchmark before or after it unless the user explicitly requested a benchmark in the same message.",
